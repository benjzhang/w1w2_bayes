#!/bin/bash
#SBATCH -J gpa_circle_fresh
#SBATCH -p gpu
#SBATCH -t 01:00:00
#SBATCH --gres=gpu:1
#SBATCH --mem=8G
#SBATCH -o /work/pi_markos_umass_edu/bjzhang_umass_edu/w1w2_bayes/logs/slurm/gpa_circle_fresh_%j.out
#SBATCH -e /work/pi_markos_umass_edu/bjzhang_umass_edu/w1w2_bayes/logs/slurm/gpa_circle_fresh_%j.err
